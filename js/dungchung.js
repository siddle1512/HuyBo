      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-5">
           ...
           <a href="Chính sách.html">Chính sách bảo hành</a>
           </br>
            <a href="Chính sách.html">Chính sách đổi trả</a>
            </br>
             <a href="Chính sách.html">Chính sách bảo mật</a>
          </div>
          ...
          <div class="col-xs-6 col-md-4">
           ...
           <a href="tel:19001009">1900 1009</a>
                   ...
                   <span>Khiếu nại:</span>
                 <a href="tel:19001123">1900 1123</a>
                    (7:30 - 22:00)
                    </br>
                    <span>Bảo hành:</span>
                     <a href="tel:19001508">1900 1508</a>
                    (7:30 - 22:00)
          </div>

          <div class="col-xs-7 col-md-3">
            <h6>Kết nối với Cyborg</h6>

          <div class="col-md-0 col-sm-6 ">
            <ul class="social-icons">
              <a class="facebook" href="https://www.facebook.com/cyborgPTA"><i class="fa fa-facebook"></i></a>
              <a class="youtube" href="https://www.youtube.com/watch?v=gXcDVlqJFoU"><i class="fa fa-youtube"></i></a>           
            </ul>             
      </div>
    
             <a href="nguoidung.html"><h6 >Tài khoản cộng đồng</h6></a>
    </footer>
  </div>`);
}
