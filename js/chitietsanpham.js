...
window.onload = function () {
  ...
  var tags = ["macbook", "dell", "lenovo", "asus", "msi"];
...
function phanTich_URL_chiTietSanPham() {
  ...
  // Đổi title
  document.title = nameProduct + " - Cyborg";
  ...
  s += addThongSo("Ổ cứng", sanPhamHienTai.detail.ssd);
  s += addThongSo("Màn hình", sanPhamHienTai.detail.screen);
  s += addThongSo("Card màn hình", sanPhamHienTai.detail.card);
  s += addThongSo("Cổng kết nối", sanPhamHienTai.detail.usb);
  s += addThongSo("Hệ điều hành", sanPhamHienTai.detail.os);
  s += addThongSo("Thiết kế", sanPhamHienTai.detail.des);
  s += addThongSo("Kích thước, khối lượng", sanPhamHienTai.detail.size);
  s += addThongSo("Thời điểm ra mắt", sanPhamHienTai.detail.date);
  info.innerHTML = s;
  ...
  // Hình nhỏ
  addSmallImg(
    "https://cdn.tgdd.vn/Products/Images/44/317712/Slider/vi-vn-asus-vivobook-x1404za-i3-nk246w-slider-3.jpg"
  );
  addSmallImg(
    "https://cdn.tgdd.vn/Products/Images/44/317712/Slider/vi-vn-asus-vivobook-x1404za-i3-nk246w-slider-2.jpg"
  );
  addSmallImg(
    "https://cdn.tgdd.vn/Products/Images/44/317712/Slider/vi-vn-asus-vivobook-x1404za-i3-nk246w-slider-6.jpg"
  );
  addSmallImg(
    "https://cdn.tgdd.vn/Products/Images/44/317712/Slider/vi-vn-asus-vivobook-x1404za-i3-nk246w-slider-7.jpg"
  );
  addSmallImg(
    "https://cdn.tgdd.vn/Products/Images/44/317712/Slider/vi-vn-asus-vivobook-x1404za-i3-nk246w-slider-5.jpg"
  );
  addSmallImg(
    "https://cdn.tgdd.vn/Products/Images/44/317712/Slider/vi-vn-asus-vivobook-x1404za-i3-nk246w-slider-3.jpg"
  );
